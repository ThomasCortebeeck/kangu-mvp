...
<html class="no-js" lang="en">
  ...
  <!--Header section-->
    ...
    <div class="full-width-height" data-interchange="[assets/header/header-background-1366.jpg, default], 
                                   [assets/header/header-background-320.jpg, only screen and (min-width: 0px) and (max-width: 320px)],
                                   [assets/header/header-background-480.jpg, only screen and (min-width: 321px) and (max-width: 480px)], 
                                   [assets/header/header-background-640.jpg, only screen and (min-width: 481px) and (max-width: 640px)],
                                   [assets/header/header-background-720.jpg, only screen and (min-width: 641px) and (max-width: 720px)], 
                                   [assets/header/header-background-1024.jpg, only screen and (min-width: 721px) and (max-width: 1024px)], 
                                   [assets/header/header-background-1280.jpg, only screen and (min-width: 1025px) and (max-width: 1280px)], 
                                   [assets/header/header-background-1366.jpg, only screen and (min-width: 1281px) and (max-width: 1366px)], 
                                   [assets/header/header-background-1440.jpg, only screen and (min-width: 1367px) and (max-width: 1440px)], 
                                   [assets/header/header-background-1680.jpg, only screen and (min-width: 1441px) and (max-width: 1680px)], 
                                   [assets/header/header-background-1920.jpg, only screen and (min-width: 1681px) and (max-width: 1920px)],
  ...
  <!--Probleemstelling section-->
    ...
    <div class="full-width-probleemstelling">
        <div class="row row-probleemstelling">
            ...
            <div class="small-12 medium-12 large-12 small-centered columns" data-equalizer="oplossingen">
                <div class="small-12 medium-6 large-3 columns probleemstelling-card" data-equalizer-watch="oplossingen">
                    <ul>
                        <li><img src="assets/probleemstelling/familie-vrienden-icon.svg"></li>
                        <li>Familie & vrienden</li>
                        <li>Zeer toegankelijk</li>
                        <li>Goedkoopste alternatief</li>
                        <li>Afstandsproblemen</li>
                    </ul>
                </div>

                <div class="small-12 medium-6 large-3 columns probleemstelling-card" data-equalizer-watch="oplossingen">
                    <ul>
                        <li><img src="assets/probleemstelling/buitenschoolse-opvang-icon.svg"></li>
                        <li>Buitenschoolse opvang</li>
                        <li>Speelse omgeving</li>
                        <li>Gelimiteerd aantal plaatsen</li>
                        <li>Niet overal aanwezig</li>
                    </ul>
                </div>

                <div class="small-12 medium-6 large-3 columns probleemstelling-card" data-equalizer-watch="oplossingen">
                    <ul>
                        <li><img src="assets/probleemstelling/binnenschoolse-opvang-icon.svg"></li>
                        <li>Binnenschoolse opvang</li>
                        <li>Zeer toegankelijk</li>
                        <li>Budgetvriendelijk</li>
                        <li>Niet op elke school aanwezig</li>
                    </ul>
                </div>

                <div class="small-12 medium-6 large-3 columns probleemstelling-card" data-equalizer-watch="oplossingen">
                    <ul>
                        <li><img src="assets/probleemstelling/onthaalouders-icon.svg"></li>
                        <li>Onthaalouders</li>
                        <li>Huiselijk karakter</li>
                        <li>Meer persoonlijke aandacht</li>
                        <li>Jaarlijkse vermindering</li>
                    </ul>
                </div>
            </div>
        </div>
  ...
  <!--Oplossing section-->
    ...
    <div class="full-width-oplossing">
        <div class="row">
            <div class="large-12 small-centered columns">
  ...
  <!--Business model section-->
    ...
    <div class="full-width-business-model">
        <div class="row row-business-model">
            <div class="large-12 small-centered columns">
